...
public class MagicAttackStrategy implements IAttackStrategy {
    private static final AtomicInteger projectileIdCounter = new AtomicInteger(5000);
    private final int projectileCount;
    private final double speed;

    public MagicAttackStrategy(int projectileCount, double speed) {
